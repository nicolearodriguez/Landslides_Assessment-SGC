...
# Pendiente
Ruta_Pendiente = data_path + '/Curva_Exito/Wf_Pendiente.tif'
...
Ruta_SubunidadesGeomorf = data_path + '/Curva_Exito/Wf_SubunidadesGeomorf.tif'
...
Output = data_path + '/Curva_Exito/Suma_LSI.tif'
...
rasterfile = data_path + '/Curva_Exito/Suma_LSI.tif'
...
if os.path.isfile(data_path + '/Pre_Proceso/Zona_Estudio.shp') is True:
    ...
    Capa_LSI = rasterfile
    Capa_LSI_Ajustada = data_path + '/Curva_Exito/LSI.tif'
    ...
    rasterfile = data_path + '/Curva_Exito/LSI.tif'
...
if Deslizamientos.wkbType() == QgsWkbTypes.Point:
    ...
    output = data_path+'/Curva_Exito/ValoresLSI.shp'
    ...
    ValoresRaster = QgsVectorLayer(data_path + '/Curva_Exito/ValoresLSI.shp', 'ValoresLSI')
else:
    ...
    Deslizamiento_Condicion = data_path + '/Curva_Exito/DeslizamientosLSI.tif'
    ...
    Estadisticas_Deslizamiento = data_path + '/Curva_Exito/DeslizamientosLSIEstadistica.csv'
...
alg = "native:rasterlayerzonalstats"
output = data_path + '/Curva_Exito/LSIEstadistica.csv'
...
FILE_NAME = data_path + '/Curva_Exito/LSIEstadistica.csv'
...
DF_Susceptibilidad.reset_index().to_csv(data_path + '/Curva_Exito/DF_LSI.csv', header=True, index=False)
...
fig.savefig(data_path+'/Curva_Exito/Curva_Exito.jpg')  # Se guarda la gráfica en formato .jpg

# Reclasificación del mapa raster
alg = "native:reclassifybylayer"
RasterReclass = data_path + '/Curva_Exito/LSI.tif'
Tabla = data_path + '/Curva_Exito/DF_LSI.csv'
...
Susceptibilidad = iface.addRasterLayer(data_path + '/Resultados/Susceptibilidad_Deslizamientos.tif', "Susceptibilidad_Deslizamientos")
