...
rasterfile = data_path + '/Pre_Proceso/SubunidadesGeomorf.tif'

# Se lee el archivo con los puntos correspondientes a deslizamientos
...
if Deslizamientos.wkbType()== QgsWkbTypes.Point:
    ...
    ValoresRaster = QgsVectorLayer(data_path + '/Pre_Proceso/ValoresGeomorfo.shp', 'ValoresUGS')
    ...
    Deslizamiento_Condicion = data_path+'/Pre_Proceso/DeslizamientosGeomorfo.tif'
    ...
    Estadisticas_Deslizamiento = data_path+'/Pre_Proceso/DeslizamientosGeomorfoEstadistica.csv'
