...
ValoresRaster = QgsVectorLayer(data_path+'/Pre_Proceso/ValoresCambioCobertura.shp','ValoresCambioCobertura')
...
iface.addRasterLayer(data_path+'/Resultados/CoberturaWf.tif',"CoberturaWf")
